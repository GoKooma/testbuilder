...
describe('Discover', function() {
  ...
  it('has a prefix of 65 and a length of 16', function () {
    expect(detectNetwork('6540649890123456')).to.equal('Discover');
  });

  it('has a prefix of 65 and a length of 19', function () {
    expect(detectNetwork('6540649890123456789')).to.equal('Discover');
  });
});
...
describe('Maestro', function() {
  ...
  var expect = chai.expect;
  let prefix = ['5018', '5020', '5038', '6304'];
  var tempCardNumb;

  for (let i of prefix) {
    tempCardNumb = i + '12345678';
    for (let j = 12; j <= 19; j++) (function(tempCardNumb) {
